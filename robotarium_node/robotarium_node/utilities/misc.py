...
def generate_initial_conditions(N, spacing=0.3, width=3, height=1.8):
    """Generate random initial conditions in an area of the specified
...
def determine_marker_size(robotarium_instance, marker_size_meters):
    ...
    fig_dim_pixels = robotarium_instance.axes.transData.transform(
        np.array([[robotarium_instance.boundaries[2]],
