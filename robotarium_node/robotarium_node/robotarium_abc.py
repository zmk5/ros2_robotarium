"""A Robotarium helper class containing useful attributes and methods.
...
class RobotariumABC(ABC):
    """Interface for the Robotarium class.

    This class ensures the simulator and the robots match up properly.

    NOTE: THIS FILE SHOULD NEVER BE MODIFIED OR SUBMITTED!
    ...
    def __init__(
        ...
        """Instantiate RobotariumABC class."""
    ...
    def _uni_to_diff(self, dxu) -> np.ndarray:
        r = self.wheel_radius
        l = self.base_length
        dxdd = np.vstack(
    ...
    def _validate(self, errors={}) -> Dict:
        """Check that robots are operating within the bounds of reality."""
