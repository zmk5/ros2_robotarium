"""Unicycle Differential-Drive Barrier Certificates with Boundary Example.
...
def main() -> None:
    ...
    uni_barrier_cert = create_unicycle_differential_drive_barrier_certificate_with_boundary()
